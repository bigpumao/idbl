    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <div class="row">
                    <div class="col-md-3">
                        <h2><a href="{{route('categoria.create')}}" data-toggle="tooltip" data-placement="top" title="Nova Categoria"><i class="fa fa-plus" aria-hidden="true"></i></a></h2>
                    </div>
        ...
        <script type="text/javascript">
            ...
            $('#datatables').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{route('categoria.datatables')}}",
                columns: [
                    {data: 'id', name: 'id'},
