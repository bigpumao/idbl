<head>
    ...
    <title>{{$titulo or "Sistema de Administração IDBL"}}</title>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{url('/')}}/template/plugins/iCheck/flat/blue.css">
    <!-- Morris chart -->
    <link rel="stylesheet" href="{{url('/')}}/template/plugins/morris/morris.css">
    <!-- jvectormap -->
    <link rel="stylesheet" href="{{url('/')}}/template/plugins/jvectormap/jquery-jvectormap-1.2.2.css">
    <!-- Date Picker -->
    <link rel="stylesheet" href="{{url('/')}}/template/plugins/datepicker/datepicker3.css">
    <!-- Daterange picker -->
